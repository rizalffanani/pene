...
export class GetapiService {
  ...
  getListItemstoko(params) {
    return this.http.get(this.API_URL + 'allproduk' + params);
  }
  ...
  getNews() {
    return this.http.get(this.API_URL + 'news').pipe();
  }

  getListItems(params) {
    return this.http.get(this.API_URL + 'allnews' + params);
  }
  ...
  getwww(id) {
    return this.http.get(this.API_URL + 'produkwww?pid=' + id).pipe();
  }
}